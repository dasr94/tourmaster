...
if( $page_type != '' ){
	...
	?>
	<div class="gdlr-core-pbf-wrapper " style="margin: 0px 0px 0px 0px;padding: 0px 0px 115px 0px; height: 720px;">
	...
	<form class="tourmaster-form-field  tourmaster-medium" action="https://theoutdoortrip.com/tours/" method="GET">
		<div id="div-guide" class="tourmaster-tour-search-field tourmaster-tour-search-field-tax" style="padding-right: 10px;margin-bottom: 10px;">
			...
			<input autocomplete="off" type="text" value="" placeholder="Search by guide" max="6" id="guide_name" name="guide_name"/>
		</div>
		<div id="div-start" class="tourmaster-tour-search-field tourmaster-tour-search-field-date" style="padding-right: 10px;margin-bottom: 10px;">
			<div class="tourmaster-datepicker-wrap" >
				<label>Trip Date</label>
					<input readonly class="tourmaster-datepicker" type="text" value="" placeholder="" data-date-format="<?php esc_attr(tourmaster_get_option('general', 'datepicker-date-format', 'dd mm yy')) ?>" >
					<input class="tourmaster-datepicker-alt" name="start_date_search" type="hidden" value=""/>
			</div>
		</div>
												...
												<?php
													...
													if(empty($sld)){
														...
														foreach ($sld as $ky => $value) {
															echo "<div style='flex: 3; flex-basis: 32%;'>";
															...
															<a class="gdlr-core-ilightbox gdlr-core-js " href="'.$imgBig.'" data-type="image">
													...
													<style>
														...
														echo '<div class="tourmaster-item-list tourmaster-tour-full tourmaster-item-mglr clearfix tourmaster-tour-frame trip_item" style="height: 230px" id="card-trip-item">
															...
															<div class="tourmaster-tour-full-inner trips_item_content" style="padding: 10px !important">
																...
																<div class="tourmaster-tour-content-wrap custom-warp-g-t2 clearfix gdlr-core-skin-e-background" style="border-left: 1px solid #828282; padding-left: 10px; width: 25% " id="card-trip-item-2">
																	<div class="tourmaster-center-tour-content" style="padding-top: 21.5px; padding-bottom: 21.5px;">
...
echo "</table>";
														...
														<div style="display: flex; flex-direction: row; justify-content: space-between;"> 
														<div> <h6>April</h6> </div>
														<div> <span style="font-size: 24px; font-weight: 700; color: #000;" onclick="prevMonth('.$post->ID.',4)"><</span> </div>
														</div>';
