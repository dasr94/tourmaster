										...
										<div class="gdlr-core-gallery-item gdlr-core-item-pdb clearfix  gdlr-core-gallery-item-style-slider gdlr-core-item-pdlr " style="display: flex; flex-direction: row; flex-wrap: wrap;">
											<!-- <div class="gdlr-core-flexslider flexslider gdlr-core-js-2 " data-type="slider" data-effect="default" data-nav="navigation"> -->
												<!-- <div class="flex-viewport" style="overflow: hidden; position: relative;"> -->
													<!-- <ul class="slides" style="width: 1400%; margin-left: -867px;"> -->
														<?php
															...
															if(empty($sld)){
																...
																foreach ($sld as $ky => $value) {
																	...
																	// $imgBig = $value->thumbnail;
																	/* echo '<li class="clone" aria-hidden="true" style="width: 867px; margin-right: 0px; float: left; display: block;">';
																	...
																	echo '<img src="'.$imgBig.'" alt="" width="300" height="218" title="Largemouth-Bass-358×260" draggable="false">';
